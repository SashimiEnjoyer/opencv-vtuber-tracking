...
namespace CVVTuber
{
    public class FaceLandmarkHeadPositionAndRotationGetter : CVVTuberProcess, IHeadPositionGetter, IHeadRotationGetter
    {
        ...
        protected bool m_didUpdateHeadPositionAndRotation;

        public bool didUpdateHeadPositionAndRotation
        {
            set { m_didUpdateHeadPositionAndRotation = value; }
            get { return m_didUpdateHeadPositionAndRotation; }
        }
        ...
        public override void Setup()
        {
            ...
            //set 3d face object FaceLandmarkConnector.instance.landmarkPoints.
            ...
            m_didUpdateHeadPositionAndRotation = false;
        }
        ...
        public override void UpdateValue()
        {
            ...
            //List<Vector2> FaceLandmarkConnector.instance.landmarkPoints = faceLandmarkGetterInterface.GetFaceLanmarkPoints();
            if (FaceLandmarkConnector.instance.landmarkPoints != null)
            {
                MatOfPoint3f objectPoints = null;

                if (FaceLandmarkConnector.instance.landmarkPoints.Count == 68)
                {

                    objectPoints = objectPoints68;

                    imagePoints.fromArray(
                        new Point((FaceLandmarkConnector.instance.landmarkPoints[38].x + FaceLandmarkConnector.instance.landmarkPoints[41].x) / 2, (FaceLandmarkConnector.instance.landmarkPoints[38].y + FaceLandmarkConnector.instance.landmarkPoints[41].y) / 2),//l eye (Interpupillary breadth)
                        new Point((FaceLandmarkConnector.instance.landmarkPoints[43].x + FaceLandmarkConnector.instance.landmarkPoints[46].x) / 2, (FaceLandmarkConnector.instance.landmarkPoints[43].y + FaceLandmarkConnector.instance.landmarkPoints[46].y) / 2),//r eye (Interpupillary breadth)
                        new Point(FaceLandmarkConnector.instance.landmarkPoints[30].x, FaceLandmarkConnector.instance.landmarkPoints[30].y),//nose (Tip)
                        new Point(FaceLandmarkConnector.instance.landmarkPoints[33].x, FaceLandmarkConnector.instance.landmarkPoints[33].y),//nose (Subnasale)
                        new Point(FaceLandmarkConnector.instance.landmarkPoints[0].x, FaceLandmarkConnector.instance.landmarkPoints[0].y),//l ear (Bitragion breadth)
                        new Point(FaceLandmarkConnector.instance.landmarkPoints[16].x, FaceLandmarkConnector.instance.landmarkPoints[16].y)//r ear (Bitragion breadth)
                    );

                }
                else if (FaceLandmarkConnector.instance.landmarkPoints.Count == 17)
                {

                    objectPoints = objectPoints17;

                    imagePoints.fromArray(
                        new Point((FaceLandmarkConnector.instance.landmarkPoints[2].x + FaceLandmarkConnector.instance.landmarkPoints[3].x) / 2, (FaceLandmarkConnector.instance.landmarkPoints[2].y + FaceLandmarkConnector.instance.landmarkPoints[3].y) / 2),//l eye (Interpupillary breadth)
                        new Point((FaceLandmarkConnector.instance.landmarkPoints[4].x + FaceLandmarkConnector.instance.landmarkPoints[5].x) / 2, (FaceLandmarkConnector.instance.landmarkPoints[4].y + FaceLandmarkConnector.instance.landmarkPoints[5].y) / 2),//r eye (Interpupillary breadth)
                        new Point(FaceLandmarkConnector.instance.landmarkPoints[0].x, FaceLandmarkConnector.instance.landmarkPoints[0].y),//nose (Tip)
                        new Point(FaceLandmarkConnector.instance.landmarkPoints[1].x, FaceLandmarkConnector.instance.landmarkPoints[1].y),//nose (Subnasale)
                        new Point(FaceLandmarkConnector.instance.landmarkPoints[6].x, FaceLandmarkConnector.instance.landmarkPoints[6].y),//l ear (Bitragion breadth)
                        new Point(FaceLandmarkConnector.instance.landmarkPoints[8].x, FaceLandmarkConnector.instance.landmarkPoints[8].y)//r ear (Bitragion breadth)
                    );

                }
                else if (FaceLandmarkConnector.instance.landmarkPoints.Count == 6)
                {
                ...
                if (!isNotInViewport)
                {
                    ...
                    m_didUpdateHeadPositionAndRotation = true;
                }
            }
        ...
        {
            if (m_didUpdateHeadPositionAndRotation)
            {
                return headPosition;
            }
            else
