...
namespace CVVTuber
{
    public abstract class FaceAnimationController : CVVTuberProcess
    {
        ...
        //[SerializeField] protected HalfBodyTrackingCharacterSetUp characterSetup;
        //CharacterCreationManager character;
        //protected SkinnedMeshRenderer faceBlendShape;
        ...
        public bool isUsingBlinkEye;

        [Range(0, 1)]
        public float BrowRightParam = 0;

        [Range(0, 1)]
        public float BrowLeftParam = 0;

        [Range(0, 1)]
        public float EyeRightParam = 0;

        [Range(0, 1)]
        public float EyeLeftParam = 0;

        [Range(0, 1)]
        public float MouthYParam = 0;

        [Range(0, 1)]
        public float MouthXParam = 0;
        ...
        public override void UpdateValue()
        {
            ...
            if (FaceLandmarkConnector.instance.landmarkPoints != null)
            {
                ...
                UpdateFaceAnimation(FaceLandmarkConnector.instance.landmarkPoints);
        ...
        protected abstract void LateUpdateFaceAnimation();
