        ...
        public static void SetUnityChanCVVTuberSettings()
        {
            ...
            if (unitychan != null)
            {
                ...
                if (headRotationController != null)
                {
                    ...
                    headRotationController.headEffectorTransform = unitychan.transform.Find("Character1_Reference/Character1_Hips/Character1_Spine/Character1_Spine1/Character1_Spine2/Character1_Neck/Character1_Head").transform;
