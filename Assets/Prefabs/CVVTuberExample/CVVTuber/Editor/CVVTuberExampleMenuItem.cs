    ...
    public class CVVTuberExampleMenuItem : MonoBehaviour
    {
        ...
        public static void SetCVVTuberSettings()
        {
            ...
            if (cVVTuberModel != null)
            {
                ...
                {
                    headRotationController.headEffectorTransform = cVVTuberModel.transform.Find("Character001/hips/spine/chest/upper_chest/neck/head").transform;
                    EditorUtility.SetDirty(headRotationController);

                    if (headRotationController.headEffectorTransform != null)
                    {
                ...
                FaceBlendShapeControllerExample faceBlendShapeController = FindObjectOfType<FaceBlendShapeControllerExample>();
