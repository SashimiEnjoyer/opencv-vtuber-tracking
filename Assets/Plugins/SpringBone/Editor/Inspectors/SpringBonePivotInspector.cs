    ...
    public class SpringBonePivotInspector : Editor
    {
        ...
        private void InitializeButtons()
        {
            ...
            buttons = new InspectorButton<SpringBonePivot>[] {
                new InspectorButton<SpringBonePivot>("Select Spring Manager", SelectSpringManager),
                new InspectorButton<SpringBonePivot>("Select Bone From Pivot", SelectBoneFromPivot)
            };
        }
