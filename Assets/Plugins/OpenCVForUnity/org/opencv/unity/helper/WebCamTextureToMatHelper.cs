    ...
    public class WebCamTextureToMatHelper : MonoBehaviour
    {
       ...
       // [SerializeField] TMP_Text debugText;
        ...
        public virtual void Initialize()
        {
            ...
            StartCoroutine(initCoroutine);  // Cuma initialize pool camera
        }
        ...
        /// Initialize pool of web camera only
        /// Cuma buat inisiasi pool camera jika ada camera
        /// </summary>
        protected virtual IEnumerator _Initialize()
        {
            ...
            //            else
            //            {
            //                Debug.Log( "Using Camera : " + webCamTexture.deviceName);
            //            }
        ...
        /// <summary>
        /// This is for choose camera spesifically by using dropdown UI
        /// Function untuk pilih camera di dropdown UI
        /// </summary>
        /// <param name="_camIndex"></param>
        /// <returns>Index camera for dropdown value</returns>
        public IEnumerator SetWebCam(int _camIndex)
        {
        ...
        if (!(bool)coroutine.Current)
        {
            ...
            webCamDevice = devices[_camIndex];
